...
<section class="grid grid-cols-12 gap-1 my-5 p-2">
            ...
            <div class="flex justify-between">
              <div>
                @if ($post->user_id == auth()->id())
                  <p class="text-dark text-center bg-neutral-900 px-2 py-1 w-fit rounded ">The contest is your own</p>
                @endif  
              </div>
            </div>  
            <div class="flex justify-between ">
  ...
  <div class="col-span-12 flex justify-between items-end flex-col">
    ...
    <a href="/user/create" class="flex justify-center items-center text-center bg-neutral-900 text-white rounded my-3 w-28 h-7 p-1 hover:bg-stone-800">create contest</a>
  </div>                             
</section>
@endsection
